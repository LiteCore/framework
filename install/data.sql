...
('images', 'local', 'AVIF Enabled', 'Use AVIF images if supported by the browser.', 'avif_enabled', '0', 'toggle("e/d")', 0, 44, NOW(), NOW()),
('images', 'local', 'WebP Enabled', 'Use WebP images if supported by the browser.', 'webp_enabled', '0', 'toggle("e/d")', 0, 45, NOW(), NOW()),
