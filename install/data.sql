...
('listings', 'global', 'Maintenance Mode', 'Maintenance mode will enable a slash screen that the site is down for maintenance.', 'maintenance_mode', '0', 'boolean', 'toggle()', 0, 2),
...
('advanced', 'global', 'GZIP Enabled', 'Compresses browser data. Increases the load on the server but decreases the bandwidth.', 'gzip_enabled', '1', 'boolean', 'toggle()', 5, 0),
('advanced', 'global', 'System Cache Enabled', 'Enables the system cache module which caches frequently used data.', 'cache_enabled', '1', 'boolean', 'toggle()', 0, 10),
('advanced', 'global', 'Clear System Cache', 'Remove all cached system information.', 'cache_clear', '0', 'boolean', 'toggle()', 0, 11),
...
('security', 'local', 'CAPTCHA', 'Prevent robots from posting form data by enabling CAPTCHA security.', 'captcha_enabled', '1', 'boolean', 'toggle()', 0, 16),
