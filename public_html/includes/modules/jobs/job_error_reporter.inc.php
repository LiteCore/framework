		...
		function settings() {
			...
			return [
				...
				[
					...
					'description' => t(__CLASS__.':description_working_hours', 'During which hours of the day the job should operate e.g. 07:00-21:00.'),
					'function' => 'text()',
				],
				[
					'key' => 'frequency',
					...
					'description' => t(__CLASS__.':description_frequency', 'How often this job should be processed.'),
					'function' => 'radio("Hourly","Daily","Weekly","Monthly")',
				],
				[
					'key' => 'email_recipient',
					'default_value' => settings::get('site_email'),
					'title' => t(__CLASS__.':title_email_recipient', 'Email Recipient'),
					'description' => t(__CLASS__.':description_email_recipient', 'The email address where reports will be sent.'),
					'function' => 'text()',
				],
				[
					'key' => 'priority',
