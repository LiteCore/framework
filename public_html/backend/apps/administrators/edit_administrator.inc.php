	...
	if (isset($_POST['save'])) {
		...
		try {
			...
			if (empty($_POST['username'])) {
				throw new Exception(t('error_must_enter_username', 'You must enter a username'));
			}

			if (empty($administrator->data['id']) && empty($_POST['password'])) {
				throw new Exception(t('error_must_enter_password', 'You must enter a password'));
			}
			...
			if (!empty($_POST['password']) && empty($_POST['confirmed_password'])) {
				throw new Exception(t('error_must_enter_confirmed_password', 'You must confirm the password'));
			}
