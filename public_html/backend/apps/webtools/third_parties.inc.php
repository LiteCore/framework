...
<div class="card">
  ...
  <div class="card-action">
    <ul class="list-inline">
      <li><?php echo functions::form_button_link(document::ilink(__APP__.'/edit_third_party'), t('title_create_new_third_party', 'Create New Third Party'), '', 'add'); ?></li>
    </ul>
  </div>
    ...
    <table class="table data-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-end"><a class="btn btn-default btn-sm" href="<?php echo document::href_ilink(__APP__.'/edit_third_party', ['third_party_id' => $third_party['id']], true); ?>" title="<?php echo t('title_edit', 'Edit'); ?>"><?php echo functions::draw_fonticon('edit'); ?></a></td>
        </tr>
        <?php }?>
      </tbody>
      ...
      <tfoot>
        <tr>
          <td colspan="7"><?php echo t('title_third_parties', 'Third Parties'); ?>: <?php echo $num_rows; ?></td>
        </tr>
      </tfoot>
    </table>
