...
<div id="box-cookie-notice" class="text-center">
  ...
  <div class="btn-group">
    <?php echo functions::form_button('accept_cookies', ['1', language::translate('text_i_accept', 'I accept')], 'button', 'style="font-weight: bold;"'); ?>
    <?php echo functions::form_button('decline_cookies', ['0', language::translate('text_i_decline', 'I decline')], 'button'); ?>
  </div>
</div>
