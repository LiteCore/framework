    ...
    <div class="col-md-6">
      ...
      <?php echo functions::form_begin('contact_form', 'post'); ?>
        ...
        <div class="form-group">
          ...
          <?php echo functions::form_text_field('name', true, 'required="required"'); ?>
        </div>

        <div class="form-group">
          <label><?php echo language::translate('title_email_address', 'Email Address'); ?></label>
          <?php echo functions::form_email_field('email', true, 'required="required"'); ?>
        </div>

        <div class="form-group">
          <label><?php echo language::translate('title_subject', 'Subject'); ?></label>
          <?php echo functions::form_text_field('subject', true, 'required="required"'); ?>
        </div>

        <div class="form-group">
          <label><?php echo language::translate('title_message', 'Message'); ?></label>
          <?php echo functions::form_textarea('message', true, 'required="required" style="height: 250px;"'); ?>
        </div>
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <?php echo functions::form_captcha_field('captcha', 'contact_us', 'required="required"'); ?>
          </div>
        </div>
        <?php } ?>
