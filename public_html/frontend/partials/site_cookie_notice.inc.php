...
<div id="box-cookie-notice">
	<div class="container">
		<div class="notice">
			<?php echo strtr(t('text_cookie_notice', 'We rely on <a href="{url}">cookies</a> for storing your shopping cart and regional settings between visits and to understand how our customers use our website.'), ['{url}' => document::href_ilink('information', ['page_id' => settings::get('cookie_policy')])]); ?>
		</div>
